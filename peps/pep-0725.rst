...
upstream Python packages. Other tools resort to extracting dependencies from extension modules and shared libraries inside Python packages, like elfdeps_
(Fedora). External dependencies are currently handled manually,
