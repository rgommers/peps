...
PEP 440 semantics for version comparisons doesn't quite work. For example,
``1.2.3a`` may come after rather than before ``1.2.3`` for a package.
...
allowing that not justified by the additional complexity. If desired,
