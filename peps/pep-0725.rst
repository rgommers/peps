...
field to propagate the external runtime dependencies metadata. To avoid any
confusion in the future, this PEP also proposes to deprecate the
``Requires-External`` field altogether. The reasons are discussed below.
