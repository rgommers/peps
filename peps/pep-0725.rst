...
A `proposal to add an virtual type <https://github.com/package-url/purl-spec/pull/450>`__
...
.. JRG: A long shot for now. Assuming virtual PURLs would be formatted
.. like ``pkg:virtual/{compiler,interface}/...``.
