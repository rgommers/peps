...
Instead, two new Core Metadata fields are proposed:
...
not to leverage existing Core Metadata for the runtime information encoded in the
``[external]`` table.
...
This will require a Core Metadata version bump.
