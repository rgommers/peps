...
3. End users of packages that have external dependency metadata.
...
since the only impact will be driven by external runtime dependencies (expected to be rare).
