...
- Keeping the central registry up-to-date: curating and triaging requests
...
well connected to the Python packaging ecosystem. Hence, we propose to initially
...
The maintenance of mappings for the target ecosystems is explicitly out of scope.
