...
fields to encode instructions for command execution (install, query). A tampered
...
- or implement best-practices for integrity verification of the fetched documents.
