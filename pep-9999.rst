...
there will likely be a period of negative user experience.

TODO: can we set a target adoption level before we think it's safe to switch?
...
2. A standard specification for a collection of mappings (TODO: JSONSchema?)
